...
<div class="container-fluid">
    <h3 class="text-dark mb-4">{{ $property->name }}</h3>
    <div class="row mb-3">
        <div class="col-lg-4">
            <div class="card mb-3">
                ...
                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4"
                        src="{{ $property->logo ? asset($property->logo) : '/assets/img/briefcase-solid.svg' }}" width="160" height="160">
                    <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="name">
                                            ...
                                            <input class="form-control" type="text" id="name" value="{{ $property->name }}" name="name">
                                            @error('name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="address">
                                            ...
                                            <input class="form-control" type="text" id="address" value="{{ $property->address }}" name="address"></div>
                                            @error('address')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    </div>
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="city">
                                            ...
                                            <input class="form-control" type="city" id="city" value="{{ $property->city }}" name="city"></div>
                                            @error('city')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    </div>
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="country">
                                            ...
                                            <input class="form-control" type="country" id="country" value="{{ $property->country }}" name="country"></div>
                                            @error('country')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="website">
                                            ...
                                            <input class="form-control" type="text" id="website" value="{{ $property->website }}" name="website"></div>
                                            @error('website')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    </div>
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="email" id="email" value="{{ $property->email }}" name="email">
                                        </div>
                                            @error('email')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="phone">
                                            ...
                                            <input class="form-control" type="phone" id="phone" value="{{ $property->phone }}" name="phone">
                                        </div>
                                            @error('phone')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
