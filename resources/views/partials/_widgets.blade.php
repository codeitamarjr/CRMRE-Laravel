            ...
            <div class="card border-start-primary py-2 shadow">
                <div class="card-body">
                    <div class="row align-items-center no-gutters">
                        <div class="col me-2">
                            <div class="text-uppercase text-primary fw-bold mb-1 text-xs"><span>Earnings
                                    (monthly)</span></div>
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <div class="card border-start-success py-2 shadow">
                <div class="card-body">
                    <div class="row align-items-center no-gutters">
                        <div class="col me-2">
                            <div class="text-uppercase text-success fw-bold mb-1 text-xs"><span>Earnings (annual)</span>
                            </div>
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <div class="card border-start-info py-2 shadow">
                <div class="card-body">
                    <div class="row align-items-center no-gutters">
                        <div class="col me-2">
                            <div class="text-uppercase text-info fw-bold mb-1 text-xs"><span>Tasks</span></div>
                            <div class="row g-0 align-items-center">
                                <div class="col-auto">
                                    <div class="text-dark fw-bold h5 me-3 mb-0"><span>50%</span></div>
                                </div>
                                <div class="col">
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <div class="card border-start-warning py-2 shadow">
                <div class="card-body">
                    <div class="row align-items-center no-gutters">
                        <div class="col me-2">
                            <div class="text-uppercase text-warning fw-bold mb-1 text-xs"><span>Pending Requests</span>
                            </div>
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown no-arrow"><button class="btn btn-link btn-sm dropdown-toggle"
                        ...
                        <div class="dropdown-menu dropdown-menu-end animated--fade-in shadow">
                            <p class="dropdown-header text-center">dropdown header:</p><a class="dropdown-item"
                ...
                <div class="card-body">
                    <div class="chart-area">
                        <div class="chartjs-size-monitor">
                            ...
                            style="display: block; width: 1047px; height: 320px;" width="1047" height="320"
                ...
                <div class="card-body">
                    <div class="chart-area">
                        <div class="chartjs-size-monitor">
                            ...
                            width="494" height="320" style="display: block; width: 494px; height: 320px;"
                            class="chartjs-render-monitor"></canvas>
                    </div>
                    <div class="small mt-4 text-center"><span class="me-2"><i
                ...
                <div class="card-body">
                    ...
                    <div class="progress mb-4">
                        <div class="progress-bar bg-success" aria-valuenow="100" aria-valuemin="0"
                            aria-valuemax="100" style="width: 100%;"><span class="visually-hidden">100%</span></div>
                    </div>
                </div>
            </div>
            <div class="card mb-4 shadow">
