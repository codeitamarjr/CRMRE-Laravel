                ...
                <div class="card-body text-black">
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="employment_phone" name="employment_phone"
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-2">
                                <label class="form-label" id="landlord_phone">Landlord
                                    Phone</label>
                                <input type="text" class="form-control" id="landlord_phone" name="landlord_phone"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="inlineRadioWaitingList"
                                            value="Yes" name="waiting_list"
                                            {{ $profile['waiting_list'] == 'yes' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="inlineRadioWaitingList1">Yes</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="inlineRadioWaitingList2">No</label>
                                    </div>
                                </div>
                                @error('waiting_list')
                                    <div class="alert alert-danger">{{ $message }}</div>
