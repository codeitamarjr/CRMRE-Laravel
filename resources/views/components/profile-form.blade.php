                        ...
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                ...
                                <input type="number" class="form-control" id="employment_phone"
                                    name="employment_phone" value="{{ old('employment_phone') }}">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    ...
                                    <input type="text" class="form-control" id="landlord_name"
                                        name="landlord_name" value="{{ old('landlord_name') }}">
                                    @error('landlord_name')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col mb-2">
                                    ...
                                    <input type="number" class="form-control" id="landlord_phone"
                                        name="landlord_phone" value="{{ old('landlord_phone') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <input type="number" class="form-control" id="HAP_allowance"
                                        name="HAP_allowance" value="{{ old('HAP_allowance') }}">
                                    @error('HAP_allowance')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
