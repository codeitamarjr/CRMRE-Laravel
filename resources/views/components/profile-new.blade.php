                ...
                <div class="card-body text-black">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="pps_number" id="pps_number"
                                value="{{ old('pps_number') }}">
                            @error('pps_number')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-3">
                            <label class="form-label" id="alternative_email">Alternative E-mail Address</label>
                            <input type="alternative_email" class="form-control" name="alternative_email"
                                id="alternative_email" value="{{ old('alternative_email') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-3">
                            ...
                            <span class="font-13 text-muted">
                                <a href="https://finder.eircode.ie/" target="_blank">Find Eircode</a>
                            </span>
                        </div>
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <select class="form-select" name="employment_status" id="employment_status">
                                <option value="{{ old('employment_status') }}">
                                    {{ old('employment_status') ? old('employment_status') : 'Select' }}</option>
                        ...
                        <div class="col mb-3">
                            ...
                            <select class="form-select" name="employment_sector" id="employment_sector">
                                ...
                                <option value="{{ old('employment_sector') }}">
                                    {{ old('employment_sector') ? old('employment_sector') : 'Select' }}</option>
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="employment_position"
                                name="employment_position" value="{{ old('employment_position') }}">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="employment_company"
                                name="employment_company" value="{{ old('employment_company') }}">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="number" class="form-control" id="employment_phone" name="employment_phone"
                                value="{{ old('employment_phone') }}">
                            @error('employment_phone')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col mb-3">
                            <label class="form-label" id="employment_start_date">Start Date</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="number" class="form-control" id="extra_income" name="extra_income"
                                value="{{ old('extra_income') }}">
                            <span class="font-13 text-muted">Monthly Income</span>
                            @error('extra_income')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col mb-3">
                            <label class="form-label" id="extra_income_source">Extra Income Details</label>
                            <input type="text" class="form-control" id="extra_income_source"
                                name="extra_income_source" value="{{ old('extra_income_source') }}">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control" id="landlord_name" name="landlord_name"
                            ...
                            <div class="col mb-2">
                                <label class="form-label" id="landlord_phone">Landlord Phone</label>
                                <input type="number" class="form-control" id="landlord_phone" name="landlord_phone"
                            ...
                            <div class="col mb-3">
                                <label class="form-label" id="preferred_move_out_date">Move Out
                                    Date</label>
                                <input type="date" class="form-control" id="preferred_move_out_date"
                                    name="preferred_move_out_date" value="{{ old('preferred_move_out_date') }}">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select" id="children" name="children">
                                    <option value="{{ old('children') }}">
                                        {{ old('children') != null ? old('children') : 'Select' }}</option>
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="number" class="form-control" id="children_age" name="children_age"
                                    value="{{ old('children_age') }}">
                                @error('children_age')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select" id="car" name="car">
                                    <option value="{{ old('car') }}">
                                        {{ old('car') != null ? old('car') : 'Select' }}</option>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                                </select>
                                @error('car')
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select" id="pet" name="pet">
                                    <option value="{{ old('pet') }}">
                                        {{ old('pet') != null ? old('pet') : 'Select' }}</option>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                                </select>
                                @error('pet')
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-select" id="HAP" name="HAP">
                                    <option value="{{ old('HAP') }}">
                                        {{ old('HAP') ? 'Yes' : 'Select' }}</option>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                                </select>
                                @error('HAP')
                            ...
                            <div class="col mb-3">
                                ...
                                <input type="number" class="form-control" id="HAP_allowance" name="HAP_allowance"
                                    value="{{ old('HAP_allowance') }}">
                                @error('HAP_allowance')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="row mb-3">
                                <label class="form-label" id="waiting_list">Waiting List( Do you wish to be placed
                                    in the waiting list in case of this property is not available anymore? You will
                                    receive an email as soon as one property suitable became available):</label>
                            ...
                            <div class="col mb-3">
                                ...
                                <textarea class="form-control" id="tinyTextArea" rows="5" name="notes" maxlength="255">{{ old('notes') }}</textarea>
                            </div>
                        </div>
