                ...
                <div class="card-body text-black">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control-plaintext" name="surname"
                    ...
                    <div class="row g-2">
                        <div class="col mb-3">
                            ...
                            <input type="date" id="dob" class="form-control-plaintext" name="dob"
                                value="{{ $profile['dob'] }}">
                        </div>
                        <div class="col">
                            <label class="form-label" id="pps_number">PPS Number</label>
                            <input type="text" class="form-control-plaintext" name="pps_number" id="pps_number"
                        ...
                        <div class="col">
                            ...
                            <input type="number" class="form-control-plaintext" name="phone" id="phone"
                                value="{{ $profile['phone'] }}">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col mb-3">
                            <label class="form-label" id="alternative_email">Alternative
                                E-mail
                                Address</label>
                            <input type="alternative_email" class="form-control-plaintext" name="alternative_email"
                                id="alternative_email" value="{{ $profile['alternative_email'] }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control-plaintext" name="country" id="country"
                                value="{{ $profile['country'] }}">
                        </div>
                        <div class="col mb-3">
                            <label class="form-label" id="postcode">Postal Code</label>
                            <input type="text" class="form-control-plaintext" data-toggle="input-mask"
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control-plaintext" maxlength="7"
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control-plaintext" id="employment_position"
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="number" class="form-control-plaintext" id="income" name="income"
                        ...
                        <div class="col mb-3">
                            <label class="form-label" id="extra_income">Extra
                                Income</label>
                            <input type="number" class="form-control-plaintext" id="extra_income"
                        ...
                        <div class="col mb-3">
                            <label class="form-label" id="extra_income_source">Extra
                                Income
                                Details</label>
                            <input type="text" class="form-control-plaintext" id="extra_income_source"
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label class="form-label" id="landlord_name">Landlord
                                    Name</label>
                                <input type="text" class="form-control-plaintext" id="landlord_name"
                                    name="landlord_name" value="{{ $profile['landlord_name'] }}">
                            </div>
                            <div class="col mb-2">
                                <label class="form-label" id="landlord_phone">Landlord
                                    Phone</label>
                                <input type="number" class="form-control-plaintext" id="landlord_phone"
                            ...
                            <div class="col mb-3">
                                <label class="form-label" id="preferred_move_out_date">Move
                                    Out
                                    Date</label>
                                <input type="date" class="form-control-plaintext" id="preferred_move_out_date"
                                    name="preferred_move_out_date" value="{{ $profile['preferred_move_out_date'] }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                <label class="form-label" id="children_age">Children
                                    Age</label>
                                <input type="number" class="form-control-plaintext" id="children_age"
                                    name="children_age" value="{{ $profile['children_age'] }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label" id="car">Car</label>
                                <input type="text" class="form-control-plaintext" value="{{ $profile['car'] }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label" id="pet">Pet</label>
                                <input type="text" class="form-control-plaintext" value="{{ $profile['pet'] }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label" id="pet_breed">Breed</label>
                                <input type="text" class="form-control-plaintext" id="pet_breed" name="pet_breed"
