                                        ...
                                        <div class="card-body text-black">
                                            ...
                                            <div class="row g-2">
                                                <div class="col mb-3">
                                                    ...
                                                    <input type="date" id="dob" class="form-control-plaintext"
                                                        name="dob" value="{{ $application['dob'] }}">
                                                </div>
                                                <div class="col">
                                                    <label class="form-label" id="pps_number">PPS Number</label>
                                                    <input type="text" class="form-control-plaintext" name="pps_number"
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="number" class="form-control-plaintext" name="phone"
                                                        id="phone" value="{{ $application['phone'] }}">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col mb-3">
                                                    ...
                                                    <input type="email" class="form-control-plaintext" name="email"
                                                        id="email" value="{{ $application['email'] }}">
                                                </div>
                                                <div class="col mb-3">
                                            ...
                                            <div class="row">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control-plaintext" name="address"
                                                        id="address" value="{{ $application['address'] }}">
                                                </div>
                                                <div class="col mb-3">
                                                ...
                                                <div class="col mb-3">
                                                    ...
                                                    <input type="text" class="form-control-plaintext" name="country"
                                            ...
                                            <div class="row">
                                                <div class="col mb-3">
                                                    ...
                                                    <input type="number" class="form-control-plaintext" id="income"
                                                ...
                                                <div class="col">
                                                    <div class="row mb-3">
                                                        <label class="form-label" id="waiting_list">Waiting List( Do
